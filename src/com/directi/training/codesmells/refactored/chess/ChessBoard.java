...
public class ChessBoard
{
    ...
    /*
     * Reinicia el tablero de ajedrez.
     * 
     * Este método se encarga de limpiar todas las piezas del tablero y colocarlas en sus posiciones iniciales.
     * Se utiliza al inicio de cada nuevo juego o cuando se desea reiniciar la partida actual.
     */
