/*
 * @author: Angelo Montenegro, Eric Sanchez, Milena Vardumyan.
 * @see also: Refactoring
 */
package com.directi.training.codesmells.smelly.chess;
/*
 * Proporciona las clases para implementar un juego de ajedrez con un ciertos metodos de codigo.
 *
 * <p> Este paquete incluye clases para representar el tablero de ajedrez, las piezas del juego, los jugadores y el motor del juego.
 * También incluye una clase Position para representar las posiciones en el tablero de ajedrez.
 *
 * @since 1.0
 */
